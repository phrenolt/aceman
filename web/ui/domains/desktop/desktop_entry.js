...
//
// Hidden in no-local-desktop mode — writing a Linux .desktop file when the
// user's real desktop is elsewhere (WSL, a Lima VM, a remote box) would
// be confusing at best. `noLocalDesktop` is a transitional back-ref from
